...
RSpec.describe 'Integration tests for the show users path', type: :feature do
    before(:each) do
        ...
        @first_post = Post.create(author_id: @user.id, title: 'Hello', text: 'This is my first post', comments_counter: 2, likes_counter: 2)
        @second_post = Post.create(author_id: @user.id, title: 'Nice', text: 'This is my second post', comments_counter: 3, likes_counter: 3)
        @third_post = Post.create(author_id: @user.id, title: 'Work', text: 'This is my third post', comments_counter: 4, likes_counter: 4)
